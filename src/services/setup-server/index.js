...
var setupServer = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getMongoose()];
            case 1:
                mongoose = _a.sent();
                server = new ApolloServer({
                    typeDefs: typeDefs,
                    resolvers: resolvers,
                    extensions: [function () { return new QueryLogger(logger); }],
                    playground: {
                        shareEnabled: true,
                    },
                    context: function (_a) {
                        ...
                        return __awaiter(void 0, void 0, void 0, function () {
                            var auth, authenticatedUser, requestId;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        requestId = uuidv4();
                                        return [2 /*return*/, { mongoose: mongoose, Model: Model, authenticatedUser: authenticatedUser, requestId: requestId }];
                                }
                            });
                        });
                    },
